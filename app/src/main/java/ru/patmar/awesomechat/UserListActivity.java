...
public class UserListActivity extends AppCompatActivity {
    ...
    private void attachUserDatabaseReferenceListener() {
        databaseUser = FirebaseDatabase.getInstance("https://awesomechat-e1ef2-default-rtdb.europe-west1.firebasedatabase.app/");
        usersDatabaseReference = databaseUser.getReference().child("users");
    ...
    private void goToChat(int position) {
        ...
        intent.putExtra("userName", userArrayList.get(position).getId());
